...
const Dialogues = (props) => {
    ...
    let compiledDialoguesData = state.dialoguesData.map(dialogues => <DialogueMembers key={dialogues.id}
                                                                                      name={dialogues.name}
                                                                                      id={dialogues.id}/>)
    let compiledMessagesData = state.messagesData.map(messages => <Message key={messages.id}
